      ...
      body: Stack(
        children: [
          ...
          Container(
            child: Padding(
              padding:
                  EdgeInsets.only(left: paddingleft, bottom: paddingVertical),
              child: Column(
                mainAxisAlignment:
                    MainAxisAlignment.end, // Changed to MainAxisAlignment.start
                crossAxisAlignment:
                    CrossAxisAlignment.start, // Added CrossAxisAlignment.start
                children: [
                  Text(
                    'Search, Discover\nand Celebrate\nyour Event',
